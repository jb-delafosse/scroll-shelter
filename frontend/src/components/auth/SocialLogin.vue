    ...
    loginWithGoogle () {
      this.$gAuth
        ...
        .then(GoogleUser => {
          ...
          Vue.prototype.$userInfo = GoogleUser
        })
        .catch(error => {
